            ...
            <div className="row justify-content-center">
              <div className="col-md-12">
                <div className="section-title">
                  <h2>ANIL LUXURY CARS</h2>
                  <div className="separator"></div>
                  <p style={{ textAlign: "left" }}>
                    Welcome to ANIL LUXURY CARS, NIT FARIDABAD. We deal all
                    ...
                    <br />
                    Here in  ANIL LUXURY CARS, we sell only cars that are accidental -
                    free, non flood affected and genuine mileage. We have
                    variety of cars ranging from the lowest 1 lakh to the
                    maximum of 50 lakhs.
                    <br />
                    Here in  ANIL LUXURY CARS we provide other services to our customer
